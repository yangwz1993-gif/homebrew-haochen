...
| 门禁 | 证据 | 状态 |
|---|---|---|
| 独立用户验收 | 前 6 轮质疑均已修复；第 7 轮由同一独立 agent 聚焦复验 | 进行中 |
| 代码质量 | `make check`：364 tests，coverage 83% | PASS |
...
| DMG / Cask | 第 7 轮候选 `fdc850c8…6870c0`；legacy preflight PASS，独立复验后封板 | 进行中 |
