...
| 门禁 | 证据 | 状态 |
|---|---|---|
| 独立用户验收 | 前 5 轮质疑均已修复；第 6 轮由同一独立 agent 聚焦复验 | 进行中 |
| 代码质量 | `make check`：361 tests，coverage 83% | PASS |
...
| DMG / Cask | 第 6 轮候选 `46a69008…291af9`；legacy preflight PASS，独立复验后封板 | 进行中 |
