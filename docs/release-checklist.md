...
- [x] 连接与权限反馈完成代码修复，工程检查通过；真实服务及权限验收待所有者完成。
- [x] legacy 候选版本、内嵌版本、DMG 一致，签名验证通过。
- [ ] 交付新安装包，由所有者安装验收；保留配置、API Key、会话及系统授权。
- [ ] 所有者亲自验收。
...
rc.4 的单按钮连接、权限状态及原生检查见 [本轮连接修复记录](reviews/v0.3.4-rc.4-connection-acceptance.md)。本轮只交付安装包，现有安装未替换。
