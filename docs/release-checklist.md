...
| 门禁 | 证据 | 状态 |
|---|---|---|
| 独立用户验收 | 前 3 轮质疑均已修复；第 4 轮由同一独立 agent 聚焦复验 | 进行中 |
| 代码质量 | `make check`：360 tests，coverage 83% | PASS |
...
| DMG / Cask | 第 4 轮候选 `727e762c…6ca5aad`；legacy preflight PASS，独立复验后封板 | 进行中 |
